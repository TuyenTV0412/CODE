USE master;
GO
CREATE DATABASE ASS_PRJ301_SE1866;
GO
USE ASS_PRJ301_SE1866;
GO
...
CREATE TABLE Punish(
    PunishID INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    BookID INT NOT NULL,
    PersonID INT NOT NULL,
    PunishDetail NVARCHAR(200) NOT NULL,
    FOREIGN KEY (BookID) REFERENCES Book(BookID),
    FOREIGN KEY (PersonID) REFERENCES Person(PersonID)
);
CREATE TABLE Role(
...
INSERT INTO Person (Name, Gender, DateOfBirth, Address, Email, Phone) 
VALUES 
(N'Nguyễn Văn Nam', N'Nam', '1980-01-01', N'123 Đường A, Hà Nội', 'vana@gmail.com', '0901000001'),
(N'Nguyễn Thị Bích', N'Nữ', '1990-02-02', N'456 Đường B, Hồ Chí Minh', 'thib@gmail.com', '0902000002'),
( N'Trần Văn Lượng', N'Nam', '1985-03-03', N'789 Đường C, Đà Nẵng', 'vanc@gmail.com', '0903000003'),
( N'Phạm Quang Vũ', N'Nam', '1975-04-04', N'321 Đường D, Hà Nội', 'vand@gmail.com', '0904000004'),
( N'Lê Thị Thúy', N'Nữ', '1988-05-05', N'654 Đường E, Hồ Chí Minh', 'thie@gmail.com', '0905000005'),
(N'Phạm Văn Tiến', N'Nam', '1992-06-06', N'987 Đường F, Đà Nẵng', 'vanf@gmail.com', '0906000006'),
(N'Phạm Đức Long', N'Nam', '2004-09-27', N'123 Đường G, Hà Nội', 'longpd@gmail.com', '0907000007'),
(N'Trần Thị Linh', N'Nữ', '1995-08-08', N'456 Đường H, Hồ Chí Minh', 'thih@gmail.com', '0908000008'),
(N'Phạm Phúc Lân', N'Nam', '1998-09-09', N'789 Đường I, Đà Nẵng', 'vani@gmail.com', '0909000009'),
(N'Lê Thị Hà', N'Nữ', '1987-10-10', N'321 Đường J, Hà Nội', 'thij@gmail.com', '0910000010');
...
-- Insert data into Punish table
INSERT INTO Punish (BookID, PersonID, PunishDetail) 
VALUES 
(3,3, N'Trả muộn 5 ngày'),
(4,4, N'Mất sách'),
(6,6, N'Trả muộn 7 ngày'),
(7,7, N'Hư hỏng nhẹ');
