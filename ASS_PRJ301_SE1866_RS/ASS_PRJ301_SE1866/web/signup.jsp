                ...
                <div class="col-md-6">
                    <div class="form-signup">
                        ...
                        <form action="signup" method="post">
                            ...
                            <input name="name" type="text" id="user-fullname" class="form-control" placeholder="Full Name" required>
                            <select name="gender" id="user-gender" class="form-control" required>
                                <option value="" disabled selected>Choose gender</option>
                                <option value="Male">Male</option>
                                <option value="Female">Female</option>
                            </select>
                            <input name="date" type="date" id="user-date" class="form-control" placeholder="Birthdate" required>
                            ...
                            <input name="phone" type="tel" id="user-phone" class="form-control" placeholder="Phone" required>
                            <button class="btn btn-primary btn-block" type="submit"><i class="fas fa-user-plus"></i> Sign Up</button>
                            <a href="login.jsp" class="text-muted"><i class="fas fa-angle-left"></i> Back to login</a>
                        </form>
