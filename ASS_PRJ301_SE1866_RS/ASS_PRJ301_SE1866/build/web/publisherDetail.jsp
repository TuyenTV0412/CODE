                ...
                <div class="container">
                    ...
                    <jsp:include page="menu.jsp"></jsp:include>
                        <div class="col-lg-9">
                            ...
                            <div>
                                <a href="#editModal" class="btn btn-success" data-toggle="modal"> <span>Edit</span></a>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    <td>Website</td>
                                    <td><a href="https://${pub.website}" target="_blank" rel="noopener noreferrer">${pub.website}</a></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td>${pub.email}</td>
